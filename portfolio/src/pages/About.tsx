        ...
        >
          ...
          <p className="mb-8 about-text">
            <span>
              ...
              to the world of backend and API integration.
            </span>
            <br />
            <br />
            <span>
              I find joy in creating digital experiences that resonate with
              users, just as I've always strived to create efficient and
              organized systems in my past career. This transition allows me to
              merge my love for problem-solving and creativity, enabling me to
              construct both visually appealing and functional websites that
              hopefully leave a lasting impression.
            </span>
            <br />
            <br />
            <span>
            ...
            <span>
              ...
              continue to expand my frontend skills and explore the backend
